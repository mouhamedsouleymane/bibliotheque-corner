...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h2 mb-0">Modifier le livre</h1>
                ...
                <form action="{{ route('livres.update', $livre) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="isbn" id="isbn" value="{{ old('isbn', $livre->isbn) }}"
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" name="exemplaires_total" id="exemplaires_total"
                                    value="{{ old('exemplaires_total', $livre->exemplaires_total) }}" min="1"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($livre->image_couverture)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $livre->image_couverture) }}" alt="Couverture actuelle"
