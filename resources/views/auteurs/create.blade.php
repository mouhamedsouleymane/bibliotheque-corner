            ...
            <div class="col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h2 class="m-0 font-weight-bold text-primary">Ajouter un nouvel auteur</h2>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="bio" id="bio" rows="6" class="form-control @error('bio') is-invalid @enderror"
                                            placeholder="Entrez la biographie de l'auteur">{{ old('bio') }}</textarea>
                                        @error('bio')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12 d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-plus-circle"></i> Ajouter l'auteur
                                    </button>
                                </div>
                            </div>
                        </form>
