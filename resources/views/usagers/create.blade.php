                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h2 class="m-0 font-weight-bold text-primary">
                            <i class="bi bi-person-plus me-2"></i>Créer un nouvel usager
                        </h2>
                    ...
                    <div class="card-body">
                        <form action="{{ route('usagers.store') }}" method="POST">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                                <a href="{{ route('usagers.index') }}" class="btn btn-outline-secondary me-md-2">
                                    <i class="bi bi-x-circle me-1"></i> Annuler
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-person-plus me-1"></i> Créer l'usager
                                </button>
                            </div>
                        </form>
                    </div>
